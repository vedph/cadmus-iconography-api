...
using Cadmus.Iconography.Services;

namespace CadmusIconographyApi;
...
public static class Program
{
        ...
        IConfiguration config)
    {
        ...
        services.AddSingleton<IRepositoryProvider>(
            _ => new IconographyRepositoryProvider { ConnectionString = dataCS });

        // part seeder factory provider
        services.AddSingleton<IPartSeederFactoryProvider,
            IconographyPartSeederFactoryProvider>();
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        try
        {
            ...
            {
                options.WithTitle("Cadmus Iconography API")
